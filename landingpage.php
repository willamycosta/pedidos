...
<!--[if lte IE 8]>
  ...
  <section class="parallax-window" id="home" data-parallax="scroll" data-image-src="img/sub_header_cart.jpg" data-natural-width="1400" data-natural-height="350">
    ...
    <div id="subheader">
      ...
      <div id="sub_content">
        <h1>Procurando <strong id="js-rotating">Restaurantes,Lanchonetes,Hamburguerias,Pizzarias,Sorveterias</strong> ?</h1>
        <p>
  ...
  <div class="white_bg">
    <div class="container margin_60">
      ...
      <div class="main_title">
        <h2 class="nomargin_top">Restaurantes mais populares</h2>
        <p>
