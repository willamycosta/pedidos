...
if(empty($Url[0]) || $Url[0] == 'index'):
	...
	<body style="background: #e5ddd5 url(<?= $site; ?>uploads/<?= $img_fundo; ?>) repeat center;"> -->
...
<!-- Header ================================================== -->
<header class="header sticky" <?php if(!empty($Url[1]) && $Url[1] != 'carrinho' && $Url[1] != 'home' && $Url[1] != 'contato' && file_exists('includes/'.$Url[1] . '.php')):?><?php endif; ?>>
...
if(!empty($Url[1]) && $Url[1] != 'carrinho' && $Url[1] != 'home' && $Url[1] != 'contato' && file_exists('includes/'.$Url[1] . '.php')):
    ...
    $hours = array();      
		...
		<div class="container margin_60_35">
			...
			if(isset($Url[1]) and $Url[1]=='s'){$detect->s($Url[2]);	}
