...
if(isset($get_dados_pedido['enviar_pedido']) && $get_dados_pedido['enviar_pedido'] == 'enviar_agora'):
	...
	elseif(strlen($get_dados_pedido['telefone']) < 11):
		...
		var sound = new Howl({
			...
			//$get_dados_pedido['resumo_pedidos']   = $pedidos;
			$get_dados_pedido['resumo_pedidos']   = $pedidos == "" ? "<b>Qtd:</b> 1x PAGAMENTO PELO MERCADO PAGO<br /><b>Valor:</b> R$ ".Check::Real($get_dados_pedido['valor_taxa']+$get_dados_pedido['sub_total'])."..." : $pedidos;
